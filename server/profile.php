...
if(!isset($_GET["page"])){
  ...
  $npage=$_GET["page"]+1;
  header('location:profile.php?page='.$npage.'');
}}
             ...
             <div id="container">
               ...
               <div id="timelineContainer">
                 ...
                 <div id="timelineBackground">
                   <img src="<?php echo $folder . '/' . $resultc?>" class="bgImage" style="margin-top:-5%; width:100%; height:auto; object-fit:contain;">
                 </div>
                 ...
                 <div class="row">
                   <div class="col-md-offset-10 col-md-2">
                     ...
                     <label class="btn btn-link" style="border:0;">
                       <p style="text-align:right;font-size:2rem;">Change Cover</p>
                       <input id="my-file-selector" type="file"  name='file' style="display:none;">
                     </label>
                     <div class="col-md-offset-10 col-md-2">
                     <input  class="btn btn-info btn-fill" type="submit"  value="Upload">
                   </div>
                     </form>
                   </div>
                 </div>
                 ...
                 <div class="row">
                   <div class="col-md-offset-10 col-md-2">
                     ...
                     <label class="btn btn-link" style="border:0;">
                       <p style="text-align:right;font-size:2rem;">Change Profile Pic</p>
                       <input id="my-file-selector" type="file" name="file" style="display:none;">
                     </label>
                     <div class="col-md-offset-10 col-md-2">
                     <input type="submit" class="btn btn-info btn-fill" value="Upload">
                   </div>
                     </form>
                   </div>
                 </div>
               ...
               <div class="col-md-4 col-centered text-center">
                 <label class="btn btn-default" style="padding:7px;border:0;border-radius:50%;">
                   Down
                 </label>
               </div>
